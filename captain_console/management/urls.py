...
urlpatterns = [
    ...
    path('customers/<str:username>/delete/', views.customers_delete, name="Customer Profile"),
    path('customers/<str:username>/lock/', views.customers_lock, name="Customer Lock Account"),
    ...
    path('employees/<str:username>/delete/', views.employees_delete, name="Employee Profile"),
    path('employees/<str:username>/lock/', views.employees_lock, name="Employee Profile"),
    path('customers/<str:username>/delete/', views.employees_delete, name="Customer Delete Account"),
    path('customers/<str:username>/lock/', views.employees_lock, name="Customer Lock Account"),
